...
#df.loc[(df["aa_text"] == "Ao-Vivo") & (df.aa_center_x > 0)].iloc[0].ff_input_tap()
...
df.loc[df.aa_text.str.contains("^T.nis$", na=False, regex=True)].iloc[0]
df.loc[df.aa_text.str.contains("^T.nis$", na=False, regex=True)].iloc[
    0
].ff_sendevent_event4
df.loc[df.aa_text.str.contains("^T.nis$", na=False, regex=True)].iloc[
    0
