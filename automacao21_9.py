...
while True:
    adb.sh_input_mouse_swipe(x0=490, y0=700, x1=500, y1=300, t=1.0)
    ...
    #     continue
    try:
        df.loc[df.aa_text.str.contains(r"Resultados\s+Ao-Vivo",regex=True,na=False
        ) & (df.aa_center_x>0)].iloc[0].ff_input_tap()
        break 
